 ...
 * @author joaom
 */
public class ProdutoRemovido extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jpFundo.setBackground(new java.awt.Color(32, 33, 35));
        jpFundo.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseDragged(java.awt.event.MouseEvent evt) {
                jpFundoMouseDragged(evt);
            }
        });
        jpFundo.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                jpFundoMousePressed(evt);
            }
        });

        jLabel6.setFont(new java.awt.Font("Corbel Light", 0, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(204, 204, 204));
        jLabel6.setText("Produto removido com sucesso");
    ...
    private void jpFundoMouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jpFundoMouseDragged
        int x = evt.getXOnScreen();
        int y = evt.getYOnScreen();
        this.setLocation(x-mouseX, y-mouseY);
    }//GEN-LAST:event_jpFundoMouseDragged

    private void jpFundoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jpFundoMousePressed
        mouseX = evt.getX();
        mouseY = evt.getY();
    }//GEN-LAST:event_jpFundoMousePressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProdutoRemovido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProdutoRemovido().setVisible(true);
            }
        });
    }
