...
public class RecuperarSenha extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnRecuperar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnRecuperarjLabel6MouseClicked(evt);
            }
        ...
        lbRecuperar.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        lbRecuperar.setText("Recuperar");
        lbRecuperar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lbRecuperarMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                lbRecuperarjPanel4MouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                lbRecuperarjPanel4MouseExited(evt);
            }
        });
        ...
        btnRecuperarLayout.setHorizontalGroup(
            ...
            .addGroup(btnRecuperarLayout.createSequentialGroup()
                .addGap(88, 88, 88)
                .addComponent(lbRecuperar)
                .addContainerGap(94, Short.MAX_VALUE))
        );
        btnRecuperarLayout.setVerticalGroup(
            btnRecuperarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, btnRecuperarLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lbRecuperar, javax.swing.GroupLayout.DEFAULT_SIZE, 24, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jLabel11.setText("Recuperar senha");
    ...
    private void lbRecuperarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbRecuperarMouseClicked
        ...
        tp.setVisible(true);
        Recuperacao uc = new Recuperacao();
        uc.setVisible(true);
    }//GEN-LAST:event_lbRecuperarMouseClicked

    private void lbRecuperarjPanel4MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbRecuperarjPanel4MouseEntered
        btnRecuperar.setBackground(new java.awt.Color(57,113,177));
        lbRecuperar.setForeground(new java.awt.Color(255,255,255));
    }//GEN-LAST:event_lbRecuperarjPanel4MouseEntered

    private void lbRecuperarjPanel4MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbRecuperarjPanel4MouseExited
        btnRecuperar.setBackground(new java.awt.Color(255,255,255));
        lbRecuperar.setForeground(new java.awt.Color(0,0,0));
    }//GEN-LAST:event_lbRecuperarjPanel4MouseExited

    private void btnRecuperarjLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnRecuperarjLabel6MouseClicked
        this.dispose();
        TelaLogin2 tp = new TelaLogin2();
        tp.setVisible(true);
        Recuperacao uc = new Recuperacao();
        uc.setVisible(true);
    }//GEN-LAST:event_btnRecuperarjLabel6MouseClicked
